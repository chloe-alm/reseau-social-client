...
export default function Home(props) {
  return (
    < div className="home media_phone">
      <h2>Bienvenue</h2>
      < img className="home_image" src={imagecentre} alt="image du centre equestre" />
      <p className="home_paragraphe media_phone">Le centre équestre de Jablines et ses 5 Hectares, vous accueille à l'ouest de la Seine et Marne, à 10 Km du parc Disneyland et à 30 min par l'A4 de la porte de BERCY.<br/><br/>
      L'équipe du centre équestre vous reçoit pour vous proposer une équitation Sportive ou de Loisir dans une structure de qualité.<br/><br/>
